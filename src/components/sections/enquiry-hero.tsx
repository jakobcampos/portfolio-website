      ...
      <motion.div {...slideDown({})} className="w-1/4 py-48 flex flex-col z-10 text-p lg:text-p-lg">
        ...
        <form className="w-full h-screen flex flex-col gap-8" onSubmit={handleSubmit}>
          ...
          <div id="about" className="w-full flex flex-col gap-2">
            <span>ABOUT -</span>
            <textarea placeholder="tell me about your project" className="bg-background border border-dark p-1 min-h-16 min-w-full max-h-64 resize placeholder:text-stone" />
          </div>
          <button type="submit" className="w-full hover:bg-dark hover:text-stone transition-all duration-500 border p-2 flex justify-center mt-4">
